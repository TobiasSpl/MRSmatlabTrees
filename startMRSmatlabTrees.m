...
% set MRSmatlab path
addpath(...
   [pwd filesep 'trunk' filesep 'extern'], ...
   [pwd filesep 'trunk' filesep 'extern' filesep 'pics'], ...
   [pwd filesep 'trunk' filesep 'extern' filesep 'BLOCHUS'], ...
   [pwd filesep 'trunk' filesep 'userinterfaces'], ...
   [pwd filesep 'trunk' filesep 'userinterfaces' filesep 'icons'], ...
   [pwd filesep 'trunk' filesep 'functions'], ...
   [pwd filesep 'trunk' filesep 'functions' filesep 'MRSSigPro'], ... 
   [pwd filesep 'trunk' filesep 'functions' filesep 'MRSKernel'], ...
   [pwd filesep 'trunk' filesep 'functions' filesep 'MRSInversionQT' filesep 'GA'], ...
   [pwd filesep 'trunk' filesep 'functions' filesep 'MRSInversionQT'], ...
   [pwd filesep 'trunk' filesep 'functions' filesep 'CommonUsed']);
